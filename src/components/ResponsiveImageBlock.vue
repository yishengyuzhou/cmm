...
const imageSources: Record<ImagePromptKey, string> = {
  heroHerbs: new URL('../assets/showcase/hero-herbs.jpg', import.meta.url).href,
  rawHerbs: new URL('../assets/showcase/raw-herbs.jpg', import.meta.url).href,
  teaBlend: new URL('../assets/showcase/tea-blend.jpg', import.meta.url).href,
  wellnessDrink: new URL('../assets/showcase/wellness-drink.jpg', import.meta.url).href,
  sleepCalm: new URL('../assets/showcase/sleep-calm.jpg', import.meta.url).href,
  giftPack: new URL('../assets/showcase/gift-pack.jpg', import.meta.url).href,
  oemLabel: new URL('../assets/showcase/oem-label.jpg', import.meta.url).href,
  bulkSupply: new URL('../assets/showcase/bulk-supply.jpg', import.meta.url).href,
  cartonPacking: new URL('../assets/showcase/carton-packing.jpg', import.meta.url).href,
  mixedBatch: new URL('../assets/showcase/mixed-batch.jpg', import.meta.url).href,
  aboutProcess: new URL('../assets/showcase/about-process.jpg', import.meta.url).href,
  qualityCheck: new URL('../assets/showcase/quality-check.jpg', import.meta.url).href,
  contactDesk: new URL('../assets/showcase/contact-desk.jpg', import.meta.url).href,
